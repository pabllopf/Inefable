...
// <copyright file="StoryGraphView.cs" company="Pabllopf">GNU General Public License v3.0</copyright>
//------------------------------------------------------------------------------------------
namespace DialogueSystem.Editor
{
    ...
    public class StoryGraphView : GraphView
    {
        ...
        private DialogueNode entryPointNode = null;

        #region Constructor

        /// <summary>Initializes a new instance of the <see cref="StoryGraphView"/> class.</summary>
        ...
        public DialogueNode EntryPointNode { get => entryPointNode; set => entryPointNode = value; }
